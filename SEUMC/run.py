...
def parse_arguments():
    ...
    parser.add_argument('--logger_name', type=str, default='Structral Entrophy Guided Multimodal Semantics Discovery', help="Logger name for multimodal semantics discovery.")

    parser.add_argument('--dataset', type=str, default='MELD-DA', help="The selected dataset.", choices=['MELD-DA', 'IEMOCAP-DA', 'MIntRec'])

    parser.add_argument('--multimodal_method', type=str, default='seumc', help="which method to use.")

    parser.add_argument('--method', type=str, default='seumc', help="which method to use.")
    ...
    parser.add_argument("--train", default=True,action="store_true", help="Whether to train the model.")
    ...
    parser.add_argument('--video_feats_path', type=str, default='swin_feats.pkl', help="The directory of the video features.")
    
    parser.add_argument('--audio_feats_path', type=str, default='wavlm_feats.pkl', help="The directory of the audio features.")

    parser.add_argument('--results_path', type=str, default='results', help="The path to save results.")

    parser.add_argument("--output_path", default='outputs/MIntRec', type=str,
                        help="The output directory where all train data will be written.") 

    parser.add_argument("--model_path", default='models', type=str, 
                        help="The output directory where the model predictions and checkpoints will be written.") 

    parser.add_argument("--config_file_name", type=str, default='MIntRec', help = "The name of the config file.")
...
if __name__ == '__main__':
    ...
    args.config_file_name = f"{args.method}_{args.dataset}"
    args.output_path = f"outputs/${args.dataset}"
    args.results_file_name = f"results_${args.method}.csv"
